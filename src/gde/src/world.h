...
*/
//typedef Vector2i long_vector2d;
...
*/
//typedef Vector3i long_vector3i;
...
struct world_vector2d
{
	world_distance i, j;
	// implicit
	constexpr operator long_vector2d() const { return {i, j}; }
};
*/
...
struct world_vector3d
{
	...
	// implicit
	constexpr operator long_vector3d() const { return {i, j, k}; }
...
struct world_point2d
{
	world_distance x, y;
	// implicit
	constexpr operator long_point2d() const { return {x, y}; }
};
*/
...
struct world_point3d
{
	...
	//implicit
	constexpr operator long_point3d() const { return {x, y, z}; }
